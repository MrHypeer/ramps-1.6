...
#define STRING_CONFIG_H_AUTHOR "( BIGTREETECH)" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME " BIGTREETECH"
...
#define DELTA_EFFECTOR_OFFSET 25.25 // mm
...
#define MANUAL_Z_HOME_POS 278.2 // 打印机归位时，喷嘴到平台的高度。For delta: Distance between nozzle and print surface after homing. 
